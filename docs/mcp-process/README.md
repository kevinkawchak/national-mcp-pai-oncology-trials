...
mechanisms across the national Physical AI oncology clinical trials network.

## Diagrams

| Diagram | Description |
|---------|-------------|
| [01 - Robot Procedure Lifecycle](01-robot-procedure-lifecycle.md) | End-to-end state machine for robot-assisted clinical procedures |
| [02 - Cross-Site MCP Communication](02-cross-site-mcp-communication.md) | MCP server interactions between clinical trial sites |
| [03 - Clinical System Integration](03-clinical-system-integration.md) | FHIR, DICOM, and identity system integration pathways |
| [04 - Safety Gate Evaluation](04-safety-gate-evaluation.md) | Pre-procedure safety matrix and gate evaluation flow |
