...
\item \textbf{v1.1.0 (March 9, 2026):} Initial paper, updated documentation, and release notes.

\item \textbf{v1.2.0 (March 9, 2026):} Revised paper with formatting corrections: running header sizing, introduction restructuring, table column overlap fixes, and diagram pagination.
\end{itemize}
...
\begin{table}[H]
\centering
\caption{Development metrics for the national repository (v0.5.0 through v1.2.0).}
...
\midrule
Total span (v0.5.0 to v1.2.0) & 5 days \\
...
\begin{table}[H]
\centering
\caption{Repository quantitative summary (v1.2.0).}
...
\begin{itemize}[leftmargin=*]
\item \texttt{national-mcp-pai-oncology-trials} (v1.2.0)~\cite{kawchak2026national}
